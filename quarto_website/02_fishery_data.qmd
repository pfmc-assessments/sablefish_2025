...
#| echo: false
#| warning: false
#| fig-cap: "Distribution of age samples by gear and region for three time periods. Time periods are generally reflective of potential changes in retention: 2011 implementation of the catch share program and 2019 mortality credits begun being applied to discards in select fishery sectors. Note the ageing lab is currently working to read otoliths collected in California since 2019."
#| fig-cap-location: margin
