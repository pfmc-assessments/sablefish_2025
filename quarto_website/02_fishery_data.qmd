...
-   Are the listed management changes listed above reasonable? 

-   Are there other changes in the fishery that should be considered?
...
Previous assessments of sablefish have parameterized selectivity to be age-based to capture age-based movement.  This assessment will also explore age-based selectivity for the fishery. However, both length and age composition data from the fishery is presented below for completeness and to understand variable patterns in the data by size and age.
