...
Since the pre-assessment data workshop, the stock assessment team investigated the data from the AFSC Slope survey in depth.  During these investigations it was determined that aged fish for sablefish did not appear to be a representative sample of the lengths observed (e.g., fish identified for otolith collection were not selected randomly from all fish caught). This issue was also identified in the most recent assessment of Dover sole. 
