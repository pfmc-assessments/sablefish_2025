...
#| label: adult-by-port
#| echo: false
#| fig-cap: "Index of the availability of sablefish biomass to ports alongl the West Coast. Portsare Bellingham Bay (BLL), Astoria (AST), Charleston (Coos Bay, COS), Brook-ings (BRK), Crescent City (CRS), Eureka (ERK), Fort Bragg (BRG) and MorroBay (MRO). Availablility was calculate based on a combination of locally availablebiomass and distance from port for the 75th quarntile of fishing trips in 2015 usingresults of the species distribution model above."
#| fig-cap-location: margin
