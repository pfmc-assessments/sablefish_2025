...
Here, we evaluate using output from the GLORYS oceanographic model (described further below) for predicting variation in ln recruitment deviations from the sablefish stock assessment.
