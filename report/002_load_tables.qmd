...
# from a sourced csv file in the skeleton r chunk.
  ...
  # Load risk table projection
  load(here::here(general_dir, "risk_table", model_name, "tables", "projections.rda"))
  rt_projections_table <- projections$table 
  rt_projections_table <- rt_projections_table[, c(-2, -3)]
