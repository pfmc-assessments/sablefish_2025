...
#| warning: false
#| echo: false
#| tbl-cap: "Number of fish, hauls, trips, and calculated input sample size for discard ages from the trawl fleet."

read.csv(here::here("data-processed", "data-discard-sample-sizes-length.csv")) |>
  dplyr::select(-fleet_groups, -vessels) |>
...
#| warning: false
#| echo: false
#| tbl-cap: "Number of fish, hauls, trips, and calculated input sample size for discard ages from the hook-and-line fleet."
...
#| warning: false
#| echo: false
#| tbl-cap: "Number of fish, hauls, trips, and calculated input sample size for discard ages from the pot fleet."
...
#| warning: false
#| echo: false
#| tbl-cap: "Number of sampled trips, age samples, and calculated input sample size (Input N) by year for the trawl fleet."
...
#| warning: false
#| echo: false
#| tbl-cap: "Number of sampled trips, age samples, and calculated input sample size (Input N) by year for the hook-and-line fleet."
...
#| warning: false
#| echo: false
#| tbl-cap: "Number of sampled trips, age samples, and calculated input sample size (Input N) by year for the pot fleet."
...
kableExtra::kable(
  ...
  kableExtra::column_spec(
    ...
    width = c("2.75in", "0.5in", "0.5in", "1in", "0.5in", "0.5in", "1.25in")
  ) |>
  kableExtra::kable_styling(
    latex_options = "repeat_header",
    font_size = 8)
...
read.csv(here::here("report", "rda", "sens_3_model_para_comp.csv")) |>
  ...
  gt::cols_width(
    #tidyselect::everything() ~ px(150)
    `Metric` ~ px(175),
    tidyselect::starts_with("B") ~ px(85),
    tidyselect::starts_with("E") ~ px(85),
    tidyselect::starts_with("M") ~ px(85)
  ) |>
  gt::as_latex()
...
#| warning: false
#| echo: false
#| tbl-cap: "Removal assumptions in metric tons (mt) provided by the Groundfish Management Team for 2025-2026 by fleet. Removal assumptions were used to project OFLs and ABCs for 2027-2036."
#| tbl-pos: H
