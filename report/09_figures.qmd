...
knitr::include_graphics(
  file.path("report", "figure", "wcgbt_length_age_density.png")
)
...
knitr::include_graphics(
  file.path("report", "figure", "wcgbts_length_age_compositions.png")
)
...
knitr::include_graphics(
  file.path(model_dir, "plots", "index1_cpuedata_AFSC_Slope.png")
)
