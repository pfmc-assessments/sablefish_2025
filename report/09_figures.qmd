...
#| warning: false 
#| eval: true 
#| fig-cap: "Comparison of the distribution from all length data to the lengths from fish with ages collected by the Triennial Survey."
#| fig-alt: ""
...
#| warning: false 
#| eval: true 
#| fig-cap: "Estimated length-at-age coastwide and by area for females (solid lines) and males (dashed lines) north and south of 36 degrees N. latitude."
#| fig-alt: ""
#| fig-pos: H
#| fig-height: 4
...
![Comparison of estimated fraction unfished (e.g., stock status) when adding new data.](figures/1_data_bridging_compare4_Bratio_uncertainty.png){#fig-data-bridge-depl-1 height=3in fig-alt=""}
...
![Comparison of estimated fraction unfished (e.g., stock status) when adding new data.](figures/2_data_bridging_compare4_Bratio_uncertainty.png){#fig-data-bridge-depl-2 height=3in fig-alt=""}
...
![Comparison of estimated fraction unfished (e.g., stock status) when the estimation of annual recruitment deviations is revised.](figures/3_structure_compare3_Bratio.png){#fig-structure-bridge-depl-3 height=3in fig-alt=""}
...
![Comparison of estimated fraction unfished (e.g., stock status) when the model structure is revised.](figures/4_structure_compare3_Bratio.png){#fig-structure-bridge-depl-4 height=3in fig-alt=""}
...
![Comparison of estimated fraction unfished  (e.g., stock status) when the model structure is revised.](figures/5_structure_compare3_Bratio.png){#fig-structure-bridge-depl-5 height=3in fig-alt=""}
...
#| warning: false 
#| eval: true 
#| fig-cap: "Fit to index data for Triennial Survey (1980-1992)."
#| fig-alt: ""
#| fig-pos: H
#| fig-height: 4
...
#| warning: false 
#| eval: true 
#| fig-cap: "Fit to index data for Triennial Survey (1995-2004)."
#| fig-alt: ""
#| fig-pos: H
#| fig-height: 4
...
#| warning: false 
#| eval: true 
#| fig-cap: "Estimated time series of stock status (e.g., relative spawning output) for the base model."
#| fig-alt: ""
#| fig-pos: H
...
#| warning: false 
#| eval: true 
#| fig-cap: "Spawning ouptut (e.g., spawning biomass) trajectories from the base model and historical assessments for sablefish."
#| fig-alt: ""
#| fig-pos: H
