...
file.copy(file.path(model_dir, "plots", "SPR4_phase.png"), here::here("report", "figures", "SPR4_phase.png"), overwrite = TRUE)
file.copy(file.path(model_dir, "plots", "ts7_Spawning_output_with_95_intervals.png"), here::here("report", "figures", "ts7_Spawning_output_with_95_intervals.png"), overwrite = TRUE)
file.copy(file.path(model_dir, "plots", "yield2_yield_curve_with_refpoints.png"), here::here("report", "figures", "yield2_yield_curve_with_refpoints.png"), overwrite = TRUE)
...
Wetzel, C.R., A.M. Berger, C. Barnes, J.A. Zahner, N. Tolimieri, E.J. Ward., and M. Head. 2025. Status of the sablefish (*Anoplopoma fimbria*) off the U.S. West Coast in 2025. Pacific Fisheries Management Council, Portland, Oregon.
