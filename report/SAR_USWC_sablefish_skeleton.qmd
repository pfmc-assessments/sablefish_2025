...
if (!file.exists(file.path(model_dir, "model_output.rda"))) {
...
if (!file.exists(file.path(table_dir, "catches_es.rda"))) {
  r4ss::table_all(
    replist = model_output,
    fleetnames = c(
      "Trawl", "Hook-and-Line", "Pot", "Trawl Discard", 
      "Hook-and-Line Discard", "Pot Discard",
