...
![Estimated yield curve with reference points for the base model.](figures/yield2_yield_curve_with_refpoints.png){#fig-es-yield height=3in fig-alt=""}
...
estimate by area from the WCGBTS ([November 2019 \gls{pfmc} Meeting Decision Document](https://www.pcouncil.org/documents/2019/11/november-2019-decision-document.pdf/)).
...
The construction of a decision table and the axis of uncertainty will be discussed at the Stock Assessment Review (STAR) Panel and will be added to the report in subsequent drafts.
