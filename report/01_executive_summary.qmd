...
knitr::include_graphics(
  file.path(model_dir, "plots", "ts7_Spawning_output.png")
)
...
knitr::include_graphics(
  file.path(model_dir, "plots", "ts9_Relative_spawning_biomass.png")
)
...
knitr::include_graphics(
  file.path(model_dir, "plots", "ts11_Age-0_recruits_(1000s).png")
)
