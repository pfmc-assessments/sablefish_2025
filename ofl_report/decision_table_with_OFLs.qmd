---
title: "Decision table including overfishing limits for the assessment of sablefish in 2025"
format: docx
---
...
pstar <- "pstar_45"
mod_low_A <- r4ss::SS_output(here::here("model", "base_model", "decision_table", "m", paste0("low_", pstar)), printstats = FALSE, verbose = FALSE)
mod_base_A <- r4ss::SS_output(here::here("model", "base_model", "decision_table", "m", paste0("base_", pstar)), printstats = FALSE, verbose = FALSE)
mod_high_A <- r4ss::SS_output(here::here(here::here("model", "base_model", "decision_table", "m", paste0("high_", pstar))), printstats = FALSE, verbose = FALSE)

pstar <- "pstar_40"
mod_low_B <- r4ss::SS_output(here::here(here::here("model", "base_model", "decision_table", "m", paste0("low_", pstar))), printstats = FALSE, verbose = FALSE)
mod_base_B <- r4ss::SS_output(here::here(here::here("model", "base_model", "decision_table", "m", paste0("base_", pstar))), printstats = FALSE, verbose = FALSE)
mod_high_B <- r4ss::SS_output(here::here(here::here("model", "base_model", "decision_table", "m", paste0("high_", pstar))), printstats = FALSE, verbose = FALSE)
...
table |> 
  ...
  gt::tab_header(
    "Decision table summary of 10 year projections beginning in 2027 for alternative states of nature based on an axis of uncertainty about natural mortality for the base model. Columns range over low, base, and high states of nature and rows range over different catch level assumptions. The base model estimated natural mortality of 0.088 yr$^{-1}$ for females and males. The low state of nature assumed a natural mortality of 0.095 yr$^{-1}$ and the high state of nature assumed a natural mortality of 0.070 yr$^{-1}$ for both sexes. Catch in 2025 and 2026 were based upon removal assumptions provided by the GMT."
  )
...
#| message: false
#| eval: true
#| fig-cap: "The GMT provided removals for 2025-206 and ACLs for 2027-2036 with a P* = 0.45 and sigma = 0.5 (black line) and the model estimated OFLs for 2025-2036 from the base model (blue line), low state of nature (red line), and high state of nature (green line)."
...
#| message: false
#| eval: true
#| fig-cap: "The GMT provided removals for 2025-206 and ACLs for 2027-2036 with a P* = 0.40 and sigma = 0.5 (black line) and the model estimated OFLs for 2025-2036 from the base model (blue line), low state of nature (red line), and high state of nature (green line)."
knitr::include_graphics(
