...
![](plots/3_structure_compare11_recdevs.png){.absolute bottom=20 left=0 width="490" height="380"}


::: {.fragment}

![](plots/3_structure_compare18_smrybio.png){.absolute bottom=20 right=0 width="490" height="380"}
:::
...
- Approximately 0.6% of ages from WCGBTS are 61 years of age or older (99.5% quantile)
:::
...
::: {.notes}
An M of 0.088 equates to a max age of ~ 6 based upon the prior and in all the age data, there are 223 ages >+ 61 years (~0.2% of all ages). Out of only the WCGBTS data, there are 170 observations >= 61 years, ~0.6% of all ages
:::
...
![](plots/recruitment_retrospective_squid.png){.absolute top=240 right=240 width="540" height="440"}
