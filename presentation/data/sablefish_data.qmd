...
- The model is sensitive to the assumptions about natural mortality (*M*)

![](plots/sens_1_compare18_smrybio.png){.absolute top=240 left=0 width="480" height="350"}

![](plots/sens_3_compare18_smrybio.png){.absolute top=240 right=0 width="480" height="350"}


## Data Changes for 2025

- Add all recent fishery and survey data: removals, indices of abundance, and age compositions 
- Inclusion of additional historical age data primarily collected in Oregon
