...
![](plots/sablefish_water.png){.absolute bottom=100 right=60 width="280" height="280"}
...
- Inclusion of additional historical (1983--2000) age data primarily collected in Oregon
- Improved estimates of removals: landing and discard mortality
- New maturity-at-age and empirical weight-at-age
- New environmental recruitment index from 2000--2024
...
- Weight data was not consistently available fisheries data coastwide
...
![](plots/maturity_at_age.png){.absolute top=100 right=175 width="880" height="480"}
...
- Discard fleets: estimated discard mortality by gear type based on the domestic landings (1890--2024) and the discard rates from Pikitch (trawl) and West Coast Groundfish Observer Program (WCGOP)
  ...
  - The use of discard fleets is considered more transparent, supports unique data weighting, and improves model stability.
...
- Calculated weight discard rate by gear for 2011--2023 based upon the proportion of catch between IFQ and non-IFQ vessels using estimates from the Groundfish Expanded Multiyear Mortality report

## Discard Mortality Estimates

- 1890--1941 and 1946--2001: 
    - Trawl: average of Pikitch discard rates
    - Hook-and-Line & Pot: average of WCGOP discard rates 2002--2010
- 1942--1946: No discarding
- 2002--2023: Annual WCGOP Discard Rates
...
![](plots/compare_data_alk_all_years.png){.absolute top=230 right=155 width="880" height="380"}
...
![](plots/index1_cpuedata_NWFSC_Slope.png){.absolute bottom=40 left=200 width="580" height="340"}
...
![](plots/index1_cpuedata_Triennial_Early.png){.absolute bottom=40 left=0 width="520" height="340"}

![](plots/index1_cpuedata_Triennial_Late.png){.absolute bottom=40 right=0 width="520" height="340"}
...
![](plots/index1_cpuedata_ENV.png){.absolute top=100 right=225 width="680" height="480"}
